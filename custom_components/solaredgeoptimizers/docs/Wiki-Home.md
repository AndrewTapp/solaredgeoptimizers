...
├── CODEQUALITY.md         # Intentional patterns and suppressions for Pylint/pycodestyle (CodeFactor)
├── pyproject.toml        # Pylint and pycodestyle config (e.g. max-line-length, max-args)
